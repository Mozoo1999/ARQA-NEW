...
function DocumentIntakeScreen() {
  const [imageUri, setImageUri] = useState<string | null>(null); const [sourceLabel, setSourceLabel] = useState(""); const [selectedFile, setSelectedFile] = useState<string | null>(null); const [rawText, setRawText] = useState(""); const [fields, setFields] = useState<DocumentFields>({ vendorName: "", amount: "", documentDate: "", taxNo: "", referenceNo: "" }); const [state, setState] = useState<"idle" | "processing" | "review">("idle"); const [error, setError] = useState<string | null>(null); const [reviewNote, setReviewNote] = useState<string | null>(null);
